# 💫 About Me:
Hi, I’m <br>[FX22-Raptor](https://www.credly.com/badges/122e4f8c-a5eb-4bd9-b006-27645de766b7/public_url)<br><br>🔭Thank you for visiting my profile, feel free to reach out.<br> <br>👯 Self taught cybersecurity with practical expertise across Linux and Windows environments.<br> The correlation between AI and S&P500 were technical in technology, finance and psychology,<br>supported by real-world simulations and certification preparation.<br>I am committed to continuous improvement of both technical and soft skills.<br>🤝 Lets colaborate on any branch of tech field, finance or psychology in general<br>🌱 Be safe. <br>💬 Beware of social engineer google Rachel Tobac for info(identity undermining, overwhelm, controlled confusion, guilt tripping and love bombing) <br>and public relation on offensive method such as; <br>engineered social consents they'll gaslight and manipulate public perception.<br> Beware of the cult leader of anything that can induce cognitive dissonance. That will bring down the whole society if you let them brainwash next-generation kids.<br>⚡ Use MFA or passcode and use practical defensive method againts <br>AI to reduce attack surface because your physical assets(looks and voices) can be manipulate easily with open-source application with AI plugin.
