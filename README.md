# 💫 About Me:
Hi, I’m <br>[FX22-Raptor](https://www.credly.com/badges/122e4f8c-a5eb-4bd9-b006-27645de766b7/public_url)<br><br>🔭Thank you for visiting my profile, feel free to reach out.<br> <br>👯 I am a cybersecurity professional with practical expertise in threat detection, log analysis, and incident response across Linux and Windows environments. I have hands-on experience identifying and mitigating vulnerabilities such as XXE, LFI, and command injection, using industry-standard SOC tools like SIEM and EDR platforms. <br>By use of methodical approach enables me to effectively analyze threats and respond to incidents or not doing anything depend on situation,<br>supported by real-world simulations and certification preparation.<br>I am committed to continuous improvement of both technical and soft skills.<br>🤝 Lets colaborate in cybersecurity field in general<br>🌱 Be safe. <br>💬 Beware of social engineer(identity undermining, overwhelm, controlled confusion, guilt tripping and love bombing) <br>and public relation on offensive method such as; <br>engineered social consents they'll gaslight and manipulate public perception.<br> Beware of the cult leader of anything. Psychopath loves to generate Sociopath. <br>⚡ Use MFA or passcode and use practical defensive method againts <br>AI to reduce attack surface because your physical assets(looks and voices) can be manipulate easily with ComfyUI .
